...
import com.roberthuaman.api.module.shared.infrastructure.marshaller.MessageJsonFormatMarshaller.MessageMarshaller
...
final class RabbitMqMessagePublisher(channelFactory: RabbitMqChannelFactory) extends MessagePublisher {
  ...
  // Example: A message with routing key "roberthuaman_scala_api.video_created"
  // will be routed to the "roberthuaman_scala_api.video_created" queue.
