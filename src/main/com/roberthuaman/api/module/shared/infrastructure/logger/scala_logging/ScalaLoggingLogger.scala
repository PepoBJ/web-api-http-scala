package com.roberthuaman.api.module.shared.infrastructure.logger.scala_logging

import com.roberthuaman.api.module.shared.domain.Logger
import com.typesafe.scalalogging.{Logger => ScalaLogging}
import org.slf4j.MDC

final class ScalaLoggingLogger extends Logger {
  private val logger = ScalaLogging(name = "roberthuaman_scala_api")
